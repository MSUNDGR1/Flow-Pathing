...
#input: longitude and latitude of point
#output pixel coordinates x,y
def coordToPix(geotransform, latCoord, longCoord):
    xP = (longCoord - geotransform[0]) / geotransform[1]
    yP = (latCoord - geotransform[3]) / geotransform[5]
    return xP, yP
...
plt.imshow(np.log(np.log(flacc)+1))
